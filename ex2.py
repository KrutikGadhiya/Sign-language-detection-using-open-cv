...
while(cap.isOpened()):
    ...
    #hand = hand_cascade.detectMultiScale(crop_img, 1.3, 5)
    #fist = fist_cascade.detectMultiScale(crop_img, 1.3, 5)
    #C = C_cascade.detectMultiScale(crop_img)
    ...
    #for (hx, hy, hw, hh) in hand:
        # cv2.rectangle(img_cropped, (hx, hy), (hx + hw, hy + hh), (125, 125, 0), 2)
        #cv2.putText(img, 'B', (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
